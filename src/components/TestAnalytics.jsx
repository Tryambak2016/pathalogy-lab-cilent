...
const TestAnalytics = () => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      <h3 className="text-xl font-semibold mb-6 text-gray-800">Test Volume Analytics</h3>
      
      {/* Monthly Test Volume Chart */}
      <div className="p-4 rounded-lg bg-gray-50 mb-8">
        <h4 className="text-md font-semibold mb-4 text-gray-700">Monthly Test Volume</h4>
        <div className="h-72">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <Bar dataKey="tests" fill="#3B82F6" name="Total Tests" radius={[4, 4, 0, 0]} />
              <Bar dataKey="positive" fill="#F59E0B" name="Positive Results" radius={[4, 4, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
      ...
      <div className="p-4 rounded-lg bg-gray-50">
        <h4 className="text-md font-semibold mb-4 text-gray-700">Test Type Breakdown</h4>
        <div className="overflow-x-auto rounded-lg shadow-sm border border-gray-200">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-100">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Test Type</th>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {testTypes.map((test, index) => (
                <tr key={index} className="hover:bg-gray-50 transition-colors duration-150">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{test.volume}</td>
