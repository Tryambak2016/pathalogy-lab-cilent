...
const AddTestForm = () => {
  ...
  return (
    <div className="max-w-4xl w-full space-y-8 px-4 md:px-0">
      {/* Add Test Form */}
      <div className="bg-white p-6 md:p-8 rounded-xl shadow-sm border border-gray-200">
        ...
        <div className="mt-8 flex flex-col md:flex-row justify-end">
          <button className="bg-purple-600 text-white font-semibold py-2 px-6 md:px-8 rounded-lg shadow-md hover:bg-purple-700 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 w-full md:w-auto">
            Add Test
          </button>
        </div>
      </div>
