const CTASection = ({ openSignUp }) => {
  return (
    <div className="bg-purple-500">
      <div className="max-w-7x1 mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
        <h2 className="text-3xl font-extrabold tracking-tight text-while sm:text-4xl">
