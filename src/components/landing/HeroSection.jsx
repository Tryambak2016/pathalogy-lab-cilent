      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
          <div className="text-center">
            ...
            {/* CTA Buttons */}
            <div className="mt-10 flex flex-row justify-center gap-4 sm:inline-grid sm:grid-cols-2 sm:gap-5">
              <button
                onClick={() => openSignUp()}
              ...
              <button
                onClick={() => openSignIn()}
                className="flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-black bg-white md:py-4 md:text-lg md:px-10 transition-all duration-200 shadow-lg hover:shadow-xl"
              >
                Sign In
              </button>
            </div>
